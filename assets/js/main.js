...
function readmore() {
    jQuery('.read-more-link').click(function (e) { 
        jQuery(this).parent('.col-content').find('.claim-offer-button').click();
        e.preventDefault();
...
function profile_marketplace_nav() {
    if (jQuery('body').hasClass('um-page-user')) {
        $nav_marketplace = '<div class="um-profile-nav-item um-profile-nav-item-custom um-profile-nav-marketplace"><a href="?profiletab=marketplace" class="profile-nav-marketplace" title="Marketplace"> <svg xmlns="http://www.w3.org/2000/svg" width="90.78" height="90.78" viewBox="0 0 90.78 90.78"><g id="materials-svgrepo-com" transform="translate(-1 -1)"><path id="Path_35" data-name="Path 35" d="M3,22.284,36.748,3,89.78,22.284M3,22.284V46.39L56.032,65.674,89.78,46.39V22.284M3,22.284,56.032,41.569,89.78,22.284" transform="translate(0 0)" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4"/><path id="Path_36" data-name="Path 36" d="M3,12V36.106L56.032,55.39,89.78,36.106V12" transform="translate(0 34.39)" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="4"/></g></svg> <span class="title">Marketplace</span> </a></div>';
        $nav_directory = '<div class="um-profile-nav-item um-profile-nav-item-custom um-profile-nav-directory"><a href="?profiletab=directory" class="profile-nav-directory" title="Marketplace"> <svg xmlns="http://www.w3.org/2000/svg" width="133.001" height="117.4" viewBox="0 0 133.001 117.4"> <g id="people-svgrepo-com_1_" data-name="people-svgrepo-com (1)" transform="translate(2.25 -12.351)"> <path id="Union_2" data-name="Union 2" d="M-470.769-1233.849c0-6.683-5.189-25.761-28.24-25.761s-28.24,19.077-28.24,25.761a4,4,0,0,1-4,4,4,4,0,0,1-4-4c0-10.73,6.648-26.634,23.683-31.954a26.343,26.343,0,0,1-13.763-23.127,26.35,26.35,0,0,1,26.32-26.32,26.35,26.35,0,0,1,26.32,26.32,26.343,26.343,0,0,1-13.762,23.127c17.034,5.32,23.683,21.224,23.683,31.954a4,4,0,0,1-4,4A4,4,0,0,1-470.769-1233.849Zm-46.561-55.081a18.341,18.341,0,0,0,18.32,18.32,18.341,18.341,0,0,0,18.32-18.32,18.341,18.341,0,0,0-18.32-18.319A18.341,18.341,0,0,0-517.33-1288.93Z" transform="translate(533 1359.6)" fill="currentColor"/> <path id="Union_3" data-name="Union 3" d="M-470.769-1233.849c0-6.683-5.189-25.761-28.24-25.761s-28.24,19.077-28.24,25.761a4,4,0,0,1-4,4,4,4,0,0,1-4-4c0-10.73,6.648-26.634,23.683-31.954a26.343,26.343,0,0,1-13.763-23.127,26.35,26.35,0,0,1,26.32-26.32,26.35,26.35,0,0,1,26.32,26.32,26.343,26.343,0,0,1-13.762,23.127c17.034,5.32,23.683,21.224,23.683,31.954a4,4,0,0,1-4,4A4,4,0,0,1-470.769-1233.849Zm-46.561-55.081a18.341,18.341,0,0,0,18.32,18.32,18.341,18.341,0,0,0,18.32-18.32,18.341,18.341,0,0,0-18.32-18.319A18.341,18.341,0,0,0-517.33-1288.93Z" transform="translate(593.52 1327.6)" fill="currentColor"/> </g> </svg> <span class="title">Directory</span> </a></div>';
        jQuery($nav_marketplace).appendTo('.um-profile-nav');
        jQuery($nav_directory).appendTo('.um-profile-nav');
    }
}
