...
Container::make('post_meta', __('Pending Update'))
	...
	->add_fields(array(
		...
		Field::make('html', 'approve_changes')->set_html('<a href="' . get_edit_post_link($_GET['post']) . '" aria-disabled="false" class="components-button is-primary is-compact">Approve Changes</a>'),
	));
