...
Container::make('post_meta', __('Pending Update'))
	...
	->add_fields(array(
		...
		Field::make('html', 'approve_changes')->set_html('<a href="/wp-admin/post.php?post=' . isset($_GET['post']) ? $_GET['post'] : '' . '&action=edit&approve_changes=true" aria-disabled="false" class="components-button is-primary is-compact">Approve Changes</a>'),
	));
