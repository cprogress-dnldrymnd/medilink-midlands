...
$Events->supports = array('title', 'editor', 'revisions', 'thumbnail', 'author');
$Events->exclude_from_search = false;
$Events->publicly_queryable = true;
$Events->show_in_admin_bar = true;
$Events->has_archive = true;
$Events->rewrite = array(
    'with_front' => false,
    'slug'       => 'event',
);

$Events_Categories = new newTaxonomy();
$Events_Categories->taxonomy = 'events_category';
$Events_Categories->post_type = 'events';
$Events_Categories->args = array(
    'label'        => 'Categories',
    'labels'       => array(
        'name'                       => _x('Categories', 'Taxonomy General Name', 'text_domain'),
        'singular_name'              => _x('Category', 'Taxonomy Singular Name', 'text_domain'),
