                    ...
                    <div class="inner">
                        <div class="top">
                            <div class="package-main-details">
                                <div class="package-price-desc-price">
            ...
            <div class="col-lg-9">
                <div class="listings">
                    <div class="row row-flex">
                        <?php foreach ($posts as $post) { ?>
                            <?php
                            $wpsl_url = get_post_meta($post->ID, 'wpsl_url', true);
                            $wpsl_phone = get_post_meta($post->ID, 'wpsl_phone', true);
                            $wpsl_email = get_post_meta($post->ID, 'wpsl_email', true);
                            $url = addHttpsToUrl($wpsl_url);
                            if (has_term(112, 'wpsl_store_category', $post->ID)) {
                                $class = 'col-lg-10';
                                $is_patron = true;
                            } else {
                                $class = 'col-lg-12';
