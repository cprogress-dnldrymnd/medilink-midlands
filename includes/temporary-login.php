...
                        <p class="description"><?php _e('How many unique IP addresses can use this key to start a new session?', 'text_domain'); ?></p>
                    </td>
                </tr>
...
                        <p class="description"><?php _e('The current number of unique IP addresses that have used this key.', 'text_domain'); ?></p>
                    </td>
                </tr>
            </tbody>
        </table>
...
        if (is_array($sessions) && isset($sessions[$ip_address])) {
            $login_timestamp = $sessions[$ip_address];
            $expiration_time = $login_timestamp + DAY_IN_SECONDS;
